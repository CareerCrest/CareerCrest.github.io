/** 1082769825132044466 */ self.document = self;
self.window = self;
var ytcfg = {
  d: function () {
...
ytcfg.set({
  ...
  INNERTUBE_CLIENT_VERSION: "2.20230331.00.00",
  INNERTUBE_CONTEXT: {
    client: { clientName: "WEB", clientVersion: "2.20230331.00.00" },
  },
  INNERTUBE_CONTEXT_CLIENT_NAME: 1,
  INNERTUBE_CONTEXT_CLIENT_VERSION: "2.20230331.00.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
  const swPolicy = trustedTypes.createPolicy("youtubeServiceWorkerPolicy", {
    createScriptURL: function (ignored) {
      return "https://www.youtube.com/s/desktop/932eb6a8/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js";
    },
  });
  importScripts(swPolicy.createScriptURL(""));
} else {
  importScripts(
    "https://www.youtube.com/s/desktop/932eb6a8/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js"
  );
}
